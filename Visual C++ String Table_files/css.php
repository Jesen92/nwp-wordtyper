...
.button {
	...
	color:#FFFFFF;
	background:#5B5D43 none repeat-x top left;
	-moz-border-radius:0px;
	-webkit-border-radius:0px;
	webkit-border-radius:0px;
}
...
.blocksubhead {
	font:  normal 12px ;
	color:#FFFFFF;
	background:#707159 none repeat-x  ;
	padding:4px 10px 4px 10px;
...
dl.tabslight dd a:hover {
	color:red;
	background:#152D49 url(images/gradients/selected-tab-gradient-with-top-alpha.png) repeat-x 0 -4px;
}
...
blockquote.preview fieldset.postattachlist {
	background:#CCCCCC  bottom repeat-x;
...
.above_body {
	background:#053061 none repeat-x  ;
...
.toplinks ul.isuser .notifications .popupbody {
	background: #5B5D43;
	border: 1px solid #5B5D43; /* makes it look consistent with the popup background */
}
...
.toplinks ul.isuser .notifications .popupbody li a{
	...
	padding: 0 5px;
	font-weight: normal;
	border-top:1px solid #5B5D43; /* makes it look consistent with the popup background */
	text-align: left;
	padding-left: 30px;
	line-height: 26px;
}
...
.navtabs li.selected a.navtab {
	color:#000000;
	background:#152D49 url(images/gradients/selected-tab-gradient-with-top-alpha.png) repeat-x  ;
	position:relative;
	top:-4px;
	padding-top:4px;
	z-index:10;
...
.toplinks .notifications a.popupctrl {	
	...
	padding-left: 4px;
	padding-right: 15px;
	background: #5B5D43 url(images/misc/arrow.png) right center no-repeat ;
	-moz-border-radius-bottomleft: 5px;
	-moz-border-radius-bottomright: 5px;
	-webkit-border-bottom-right-radius:5px;
	-webkit-border-bottom-left-radius: 5px;
...
.toplinks .notifications a.popupctrl:hover, .toplinks .nonotifications a.popupctrl:hover, .toplinks .nonotifications a.popupctrl.active , .toplinks .notifications a.popupctrl.active{
	...
	padding-left: 4px;
	padding-right: 15px;
	background: #5B5D43 url(images/misc/arrow.png) no-repeat right center;
}
...
.newcontent_textcontrol {
	background: #727453 none repeat-x left top;
	_background-image: none;
...
.newcontent_textcontrol:hover {
	background: #5B5D43 none repeat-x left top;
	color: rgb(255, 255, 255);
	text-decoration: none;
}
